...
![有帮助的截图]({{ site.url }}/assets/2.jpg)
# 4. 那对象头具体都包含哪些内容？
todo 懵懂 什么是对象头结合虚拟机书籍
...
如果是数组的话，则还包含了数组的长度
![有帮助的截图]({{ site.url }}/assets/3.jpg)
# 5. 对于加锁，那再说下ReentrantLock原理？他和synchronized有什么区别？
todo 
...
# 9. 那多线程环境怎么使用Map呢？ConcurrentHashmap了解过吗？
...
![有帮助的截图]({{ site.url }}/assets/12.jpg)
# 11. 那么说说你对JMM内存模型的理解？为什么需要JMM？
